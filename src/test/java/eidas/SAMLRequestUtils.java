...
import static eidas.saml.SAMLBuilder.*;
...
public class SAMLRequestUtils {
  ...
  public String signFile(Resource xmlResource) throws Exception {
    ...
    Credential credential = keyManager.getCredential("https://eidas.localhost.surfconext.nl");

    Key privateKey = credential.getPrivateKey();
    X509Certificate certificate = keyManager.getCertificate("https://eidas.localhost.surfconext.nl");
